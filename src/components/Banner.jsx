  ...
  return (
    <div className=' mt-4 text-white relative font-primary'>
      ...
      <img src={banner} className='max-sm:w-[80%] w-[40%] absolute max-sm:left-[7%] sm:right-[7%] mt-[5%] max-sm:mt-4'></img>
        <div className='xl:text-[6.5vh] md:text-[3vh] sm:text-[2vh]  max-sm:text-[3vh] sm:absolute w-[35%] left-[10%] sm:mt-[15%] font-extrabold max-sm:mt-[70vh] max-sm:ml-[15%] max-sm:w-[80%]'>THE <span className='text-[#ECC960]'>FUN AND SOCIAL</span> WAY TO LEARN HOW TO INVEST</div>
      </div>
      <button className='text-[#121212] bg-[#ECC960] rounded-full px-[3.0%] py-5 md:mt-[55%] xl:mt-[32%] mt-[35%] max-sm:top-[50%] max-sm:mr-[2%] absolute left-[10%] font-semibold md:text-[0.85em] sm:text-[0.7em] max-sm:text-[1.5vh] max-sm:w-[30%] max-sm:left-[35%]'>Download Now</button>
      <div className='h-[30vh]  mt-[110vh] max-sm:mt-[30vh] bg-[#1B1B1D] pt-12 max-sm:pt-2'>
      <LogoStrip/>
