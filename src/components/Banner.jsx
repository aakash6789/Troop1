...
const Banner = () => {
  ...
  return (
    <div className=' mt-4 text-white relative font-primary'>
        ...
        <div className='xl:text-[6.5vh] md:text-[3vh] sm:text-[2vh]  max-sm:text-[3vh] absolute w-[35%] left-[10%] sm:mt-[15%] font-extrabold max-sm:mt-[55vh] max-sm:left-[15%] max-sm:w-[80%]'>THE <span className='text-[#ECC960]'>FUN AND SOCIAL</span> WAY TO LEARN HOW TO INVEST</div>
      ...
      <div className='h-[30vh]  mt-[110vh] max-sm:mt-[90vh] bg-[#1B1B1D] pt-12 max-sm:pt-2'>
      <LogoStrip/>
