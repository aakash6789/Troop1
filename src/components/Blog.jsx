...
const Blog = () => {
  ...
  return (
    <div className='bg-[#151518] w-full absolute font-primary text-white xl:top-[370vh] lg:top-[362vh]  md:mt-[340vh] max-md:mt-[270vh] max-sm:mt-[390vh]'>
        ...
        <p className='font-primary mt-6 text-[1.5vh] lg:text-[2.5vh] text-center'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis id inventore officia.</p>
        ...
        </div>:<div style={{ ...currentStyles }} id="blog" className='mt-[10%]'>
        ...
        <div className='w-full text-center mt-[5%] max-sm:mt-0'>
