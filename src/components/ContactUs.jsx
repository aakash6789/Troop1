  ...
  return (
    <div className='bg-[#151518] w-full absolute font-primary text-white xl:top-[440vh] lg:top-[390vh]  md:mt-[450vh] max-md:mt-[360vh] max-sm:mt-[580vh]'>
      <div className='flex px-[5%] justify-between text-white max-sm:flex-col max-sm:pl-[25%] '>
        ...
        <button className='bg-[#151518] border-[#FFFFFF80] border-[1px] text-[white] w-[50%] text-[0.8em] sm:pt-2 max-sm:pt-[6px] max-sm:w-[40%] flex rounded-lg lg:h-[7.5vh] md:h-[4.5vh] sm:h-[5vh] max-sm:h-[3.5vh] relative'>
            <img src={logo_apple} className='w-[15%] ml-[8%] sm:mt-[2px]'></img>
            <div className='ml-[5%]'>
        ...
        <img src={logo_playstore} className='w-[15%] ml-[8%] mt-[2px]'></img>
           ...
           <button className='bg-[#151518] border-[#FFFFFF80] border-[1px] ml-[10%] text-[white] w-[50%] text-[0.8em] sm:pt-2 max-sm:pt-[6px] max-sm:w-[40%] flex rounded-lg lg:h-[7.5vh] md:h-[4.5vh] sm:h-[5vh] max-sm:h-[3.5vh] relative'>
            <img src={logo_playstore} className='w-[15%] ml-[8%] sm:mt-[2px] max-sm:ml-[10%]'></img>
            <div className='ml-[5%]'>
        ...
        <div className='w-[25%] max-sm:w-[60%] max-sm:my-[25%] '>
         <img src={Contact_Phone}></img>
        </div>
        <div className='w-[28%] mt-[4%] max-sm:w-[80%]'>
