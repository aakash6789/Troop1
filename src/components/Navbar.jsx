...
const Navbar = () => {
  return (
       ...
       <img src={troopLogo} className='absolute left-[10%] w-[7%] max-sm:w-[15%] mt-2 '></img>
        <div className='flex  justify-between  w-2/4 absolute left-[45%] right-[5%]  md:text-[0.85em] sm:text-[0.7em] max-sm:text-[0.4em] '>
        ...
        <button className='text-[#121212] bg-[#ECC960] rounded-full px-[5%] min-sm:px-[3%] py-4 font-semibold'>Download Now</button>
